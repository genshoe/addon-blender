...
def register():
	bpy.utils.register_class(SSS_OT_overlock2)
def unregister():
	bpy.utils.unregister_class(SSS_OT_overlock2)

class SSS_OT_overlock2(bpy.types.Operator):
	bl_idname = "sss.overlock2"
	bl_label = "Overlock 2"
	bl_options = {'REGISTER', 'UNDO'}
	
	def execute(self, context):
		main(self, context)
		self.report({'INFO'}, "Overlock 2 OK")
		return {'FINISHED'}
