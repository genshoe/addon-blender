...
class SSS_OT_uv_rectangle(bpy.types.Operator):
	bl_idname = "sss.uv_rectangle"
	bl_label = "UV Rectangle"
...
def register():
	bpy.utils.register_class(SSS_OT_uv_rectangle)

def unregister():
	bpy.utils.unregister_class(SSS_OT_uv_rectangle)
